...
$(document).ready(function () {
  ...
  <div class="form-group col-md-4">
    <br>
    <input type="text" class="form-control w_90" name="Member Id" id="mobileb_no_${index}" placeholder="Enter Key" />
  </div>
  <div class="form-group col-md-6">
  <br>
    <input type="text" class="form-control w_90" name="Role" id="mobileb_no_${index}" placeholder="Enter Value" />
  </div>
