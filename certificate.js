...
<input type="text" class="form-control w_90" name="Member Id" id="mobileb_no_${index}" placeholder="Enter attribute" />
</div>
<div class="form-group col-md-6">
<label for="">Value :</label>
<input type="text" class="form-control w_90" name="Role" id="mobileb_no_${index}" placeholder="Enter attribute's value" />
</div>
